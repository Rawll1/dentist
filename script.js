/**
 * DENTIST.CH - Lovable Replacement Scripts
 */
...
// ==========================================
// 2. Language Switcher Dictionary & Logic
// ==========================================
const translations = {
    de: {
        subtitle: "Dr. med. dent. · Zürich · Seit 1990",
        headline: "Prävention heute,<br>Selbstvertrauen fürs Leben.",
        description: "Prävention heute, Selbstvertrauen fürs Leben. Seit 1990 gehen wir bei dentist.ch neue Wege: mit modernsten Technologien, ganzheitlicher Zahnmedizin und einem klaren Fokus auf Vorbeugung statt Reparatur.",
        follow: "Folgen",
        book: "Termin buchen",
        ...
        based_on: "Basierend auf über 50 Bewertungen",
    ...
    en: {
        ...
        description: "Prevention today, confidence for life. Since 1990, we at dentist.ch have been breaking new ground: with cutting-edge technologies, holistic dentistry, and a clear focus on prevention over repair.",
        follow: "Follow",
        ...
        based_on: "Based on over 50 Reviews",
    ...
    it: {
        ...
        description: "Prevenzione oggi, fiducia per la vita. Dal 1990 dentist.ch percorre nuove strade: con tecnologie all'avanguardia, odontoiatria olistica e un chiaro focus sulla prevenzione rispetto alla riparazione.",
        follow: "Segui",
        ...
        based_on: "Basato su oltre 50 Recensioni",
    ...
    fr: {
        ...
        description: "Prévention aujourd'hui, confiance pour la vie. Depuis 1990, dentist.ch innove : avec des technologies de pointe, une dentisterie holistique et l'accent sur la prévention plutôt que sur la réparation.",
        follow: "Suivre",
        book: "Prendre RDV",
        vsl_title: "BIENVENUE",
        ...
        reviews_title: "AVIS",
        based_on: "Basé sur plus de 50 Avis",
        contact_title: "CONTACT",
        form_name: "Votre Nom",
...
function initLanguageSwitcher() {
    ...
    function applyTranslations(lang) {
        const dict = translations[lang] || translations['en']; // Changed fallback to English
        ...
        // Translate chat greeting if it exists dynamically
...
footerDate.innerHTML = `© ${new Date().getFullYear()} dentist.ch - All rights reserved`;
    ...
    const observer = new IntersectionObserver((entries) => {
        entries.forEach(entry => {
            if (entry.isIntersecting) {
                ...
                // Optional: Stop observing once visible if you don't want it to fade out on scroll up
...
// ==========================================
// 4. Real Google Reviews Data & Slider
// ==========================================
const googleReviews = [
    {
        name: "Pablo Alvarez",
...
function initChatWidget() {
        ...
        if (isActive) {
            ...
            if (!hasGreeted) {
                setTimeout(() => {
                    ...
                    addMessage(greetingText, 'bot greeting'); // class 'greeting' allows dynamic transaltion updates later
                    hasGreeted = true;
                }, 400);
            }
    ...
    form.addEventListener('submit', (e) => {
        ...
        // Simulate typing and responding
        setTimeout(() => {
            const lang = localStorage.getItem('lang') || 'en';
